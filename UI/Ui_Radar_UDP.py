...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy6.setHeightForWidth(self.comboBox_MatFrom.sizePolicy().hasHeightForWidth())
        self.comboBox_MatFrom.setSizePolicy(sizePolicy6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_Display.setTabText(self.tabWidget_Display.indexOf(self.tab_ConstellationDiagram), QCoreApplication.translate("MainWindow", u"ConstellationDiagram", None))
        ...
        self.pushButton_Next.setText(QCoreApplication.translate("MainWindow", u"Next Frame", None))
