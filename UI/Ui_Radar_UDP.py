...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_video = QGroupBox(self.groupBox_Config)
        self.groupBox_video.setObjectName(u"groupBox_video")
        self.verticalLayout_9 = QVBoxLayout(self.groupBox_video)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.horizontalLayout_20 = QHBoxLayout()
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.pushButton_Video_open = QPushButton(self.groupBox_video)
        ...
        self.progressBar_file.setMinimumSize(QSize(10, 0))
        self.progressBar_file.setValue(0)

        self.horizontalLayout_10.addWidget(self.progressBar_file)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_IsSave.setText(QCoreApplication.translate("MainWindow", u"Record", None))
