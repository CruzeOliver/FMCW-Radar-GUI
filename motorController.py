import ctypes
from ctypes import (
    c_bool, c_uint, c_void_p, c_ulong, POINTER, c_ubyte, byref, c_float
)
import os
...
class MotorController:
    ...
    def _define_functions(self):
        ...
        self._CH375OpenDevice.restype = HANDLE
    ...
    def usb_initialize(self) -> bool:
        """打开设备并设置超时"""
        self._handle = self._CH375OpenDevice(0)
        if self._handle == -1 or self._handle is None:
    ...
    def motor_start(self, angle: float) -> bool:
        ...
        packet = bytearray([0] * self.CONTROL_PACKET_SIZE)

        # 第0字节：控制字
        # 0b11100000 | (angle > 0 ? 0b00000111 : 0b00000110)
        packet[0] = 0b11100000 | (0b00000111 if angle > 0 else 0b00000110)
